...
genre_c = Genre.create(name: "Sci Fi")

book_a = Book.create(title: "It", author: author_c, genre: genre_a)
book_b = Book.create(title: "Fahrenheit 451", author: author_b, genre: genre_b)
book_c = Book.create(title: "Hitchhiker's Guide", author: author_a, genre: genre_c)
